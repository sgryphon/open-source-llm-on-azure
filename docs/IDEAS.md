...
Several `infrastructure` scripts to initialize resource groups and networking addresses and routes.
...
Often also corporate IT, but not strictly required. Could be owned by a business unit. Includes Azure Monitor, KeyVault, DNS.
